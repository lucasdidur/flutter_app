...
String getNextChaveIntegracao() {
  int number_random = 27061987;
  Random random = Random.secure();
  return random.nextInt(number_random).toString() + '-' + DateTime.now().toIso8601String();
}
...
getCurrentFile(frame) {
  var name = basename(frame.uri.path).split('.')[0];
